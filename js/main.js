...
/*
Given http://httpbin.org/ip or https://api.ipify.org/?format=json
as an API endpoint that returns your current IP,
...
$(function() {
  ...
  $.getJSON("https://api.ipify.org/?format=json").done( function(data) {
    ...
    $('#inner > p').text("IP: " + result.ip);
    $('#inner > span').text("CIDR: " + result.ip + "/32");
  })
